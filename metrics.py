...
### evaluation metrics
def calc_correl (test_org, test_pred):
    # pearson correlation
    test_pr = pearson(np.array(test_org), np.array(test_pred))
    # spearman correlation 
    test_spr = spearman(np.array(test_org), np.array(test_pred))
    # kendall
    test_kt = kendall_tau(np.array(test_org), np.array(test_pred))
    return test_pr, test_spr, test_kt

def calc_rmse(test_org, test_pred):
    test_rmse = root_mean_square_error(np.array(test_org), np.array(test_pred))
    return test_rmse